...
\address{Universidade do Vale do Rio dos Sinos
    ...
    \email{cassioperin@yahoo.com.br, \{fuadfsuad, felipe.silvacunha\}@gmail.com}
}
...
\begin{abstract}
This article aims to report clearly and objectively a study of desktop
virtualization technology (in this Article called Desktop Virtualization),
identifying its characteristics and attributes, making comparisons with other
existing methods for this purpose and exemplifying experiments.
\end{abstract}

\begin{resumo}
Este artigo visa relatar de forma clara e objetiva um estudo
envolvendo a tecnologia de virtualização de desktop (neste artigo chamada de
Desktop Virtualization), identificando suas características e atributos, fazendo
comparativos com outros métodos existentes para este propósito e
exemplificando experimentos.
\end{resumo}



\section{Conceito de Virtualização}
Virtualização na área da computação diz respeito a simular uma plataforma de hardware,
sistema operacional, dispositivo de armazenamento ou recurso de rede. Basicamente
virtualização é uma técnica em que são separados aplicações e sistema operacional dos
componentes físicos de um computador, existem vários formas de se aplicar essa
tecnologia além disso esse procedimento engloba vários benefícios principalmente em
quesitos relacionados à segurança, manutenção, consumo de energia e baixo custo.
